...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "9f1b7bd7.opendatahub.io",
	...
	if err := (&controller.DataConnectServiceReconciler{
		...
		RestImage: controller.EnvOrDefault(
			...
			"quay.io/opendatahub/odh-data-connect-hub-rest@sha256:fa04fcf0b65fbb197d53d4e93581d5e7e209975fd39651f6f9022eb567dc7a5f", //nolint:lll
		),
		FlightImage: controller.EnvOrDefault(
			"RELATED_IMAGE_ODH_DATA_CONNECT_HUB_FLIGHT_IMAGE",
			"quay.io/opendatahub/odh-data-connect-hub-flight@sha256:a6728900e5a321d6f3ca08f56b09a452ee2e95cf84afafafade4b7d2d96a6e60", //nolint:lll
		),
